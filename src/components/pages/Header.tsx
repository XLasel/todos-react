...
export function Header() {
  return (
    <div className="relative flex flex-col sm:pr-8">
      <DecorationDrawing
        direction="left"
        className="absolute -left-[32px] bottom-0 hidden text-orange xs:block"
      />
      <h1 className="m-0 cursor-default font-display text-xl lowercase text-orange">
        todos
      </h1>
      <DecorationDrawing className="absolute -right-[32px] -top-[10px] hidden text-orange xs:block sm:-right-[8px]" />
